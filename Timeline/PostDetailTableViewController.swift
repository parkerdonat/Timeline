...
class PostDetailTableViewController: UITableViewController {
    ...
    // UPDATE the likesLabel, commentsLabel, using the ImageController to set the headerImageView and reloading the table view
    ...
    // USE the PostController to add a Like to the post, update the view with the updated post in the completion closure.
    ...
    // PRESENT a UIAlertController with a textfield, an 'Add Comment' action, and a 'Cancel' action
